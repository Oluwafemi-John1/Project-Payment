        ...
        <tr>
            <td style="padding: 40px 20px;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
                    ...
                    <tr>
                        <td
                            style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 50px 40px; text-align: center;">
                            <h1
                    ...
                    <tr>
                        <td style="padding: 0 40px 50px 40px; text-align: center;">
                            ...
                            <a href="#"
                                style="display: inline-block; padding: 15px 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff; text-decoration: none; border-radius: 50px; font-size: 16px; font-weight: 600; letter-spacing: 1px; box-shadow: 0 4px 15px rgba(102, 126, 234, 0.4);">
